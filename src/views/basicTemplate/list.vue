...
const formConfig = [
    ...
    { label: '爱好：', key: 'like', placeholder: '请选择爱好', type: 'select', options: [{ label: '踢足球', value: '1' }, { label: '羽毛球', value: '2' }] },
    { label: '出生日期：', key: 'timer', placeholder: '请选择日期', type: 'date', },
    { label: '日期范围：', key: 'startAndEnTime', startPlaceholder: '开始日期', endPlaceholder: '结束日期', type: 'daterange' },
    { label: '月份范围：', key: 'month', placeholder: '请选择月份', type: 'month' },
    { label: '区间值：', key: ['startNumber', 'endNumber'], startPlaceholder: '请输入', endPlaceholder: '请输入', type: 'interval' },
]
...
<template>
    <div class="list-wrapper">
        <base-search-form @clear="clear" @search="search" :config="formConfig" :data="formData"></base-search-form>
