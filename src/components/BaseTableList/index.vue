...
<template>
    <div class="table-wrapper">
        ...
        <div class="pagination flex-end">
            <el-pagination :current-page="currentPage" :page-size="pageSize" :page-sizes="[30, 50, 80, 100]"
                layout="total, sizes, prev, pager, next" :total="1000" @size-change="handleSizeChange"
